    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('syllabus', models.FileField(blank=True, null=True, upload_to=proposal.models.document_upload_location)),
                ('published_on', models.CharField(max_length=55, unique=True)),
                ('published_date', models.DateTimeField()),
                ('last_date', models.DateTimeField()),
                ('picture', models.ImageField(blank=True, null=True, upload_to=proposal.models.upload_location)),
